...
from src.algorithms.determinant.function import calculate_determinant
...
class TestCase(unittest.TestCase):
    ...
    def test_none(self):
        ...
        self.assertRaises(AlgorithmValueError, calculate_determinant, None)

    def test_empty_matrix(self):
        """Проверяет, что функция выбрасывает исключение при передаче в
        параметр пустого списка"""
        self.assertRaises(AlgorithmValueError, calculate_determinant, [])
    ...
    def test_not_square_rectangle(self):
        ...
        self.assertRaises(AlgorithmValueError, calculate_determinant, matrix)
